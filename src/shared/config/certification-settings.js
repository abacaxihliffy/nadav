...
const curriculum_1 = require("../../shared/config/curriculum");
/**
...
exports.superBlockCertTypeMap = {
    ...
    [curriculum_1.SuperBlocks.JsAlgoDataStruct]: exports.certTypes.jsAlgoDataStruct,
    ...
    // modern
    [curriculum_1.SuperBlocks.RespWebDesign]: exports.certTypes.respWebDesign,
    [curriculum_1.SuperBlocks.JsAlgoDataStructNew]: exports.certTypes.jsAlgoDataStructV8,
    [curriculum_1.SuperBlocks.FrontEndDevLibs]: exports.certTypes.frontEndDevLibs,
    [curriculum_1.SuperBlocks.DataVis]: exports.certTypes.dataVis2018,
    [curriculum_1.SuperBlocks.BackEndDevApis]: exports.certTypes.apisMicroservices,
    [curriculum_1.SuperBlocks.QualityAssurance]: exports.certTypes.qaV7,
    [curriculum_1.SuperBlocks.InfoSec]: exports.certTypes.infosecV7,
    [curriculum_1.SuperBlocks.SciCompPy]: exports.certTypes.sciCompPyV7,
    [curriculum_1.SuperBlocks.DataAnalysisPy]: exports.certTypes.dataAnalysisPyV7,
    [curriculum_1.SuperBlocks.MachineLearningPy]: exports.certTypes.machineLearningPyV7,
    [curriculum_1.SuperBlocks.RelationalDb]: exports.certTypes.relationalDatabaseV8,
    [curriculum_1.SuperBlocks.CollegeAlgebraPy]: exports.certTypes.collegeAlgebraPyV8,
    [curriculum_1.SuperBlocks.FoundationalCSharp]: exports.certTypes.foundationalCSharpV8,
    // post-modern
    // TODO: use enum
    [curriculum_1.SuperBlocks.RespWebDesignNew]: exports.certTypes.respWebDesign
    // upcoming
};
...
exports.superBlockToCertMap = {
    [curriculum_1.SuperBlocks.RespWebDesign]: Certification.RespWebDesign,
    [curriculum_1.SuperBlocks.JsAlgoDataStructNew]: Certification.JsAlgoDataStructNew,
    [curriculum_1.SuperBlocks.FrontEndDevLibs]: Certification.FrontEndDevLibs,
    [curriculum_1.SuperBlocks.DataVis]: Certification.DataVis,
    [curriculum_1.SuperBlocks.RelationalDb]: Certification.RelationalDb,
    [curriculum_1.SuperBlocks.BackEndDevApis]: Certification.BackEndDevApis,
    [curriculum_1.SuperBlocks.QualityAssurance]: Certification.QualityAssurance,
    [curriculum_1.SuperBlocks.SciCompPy]: Certification.SciCompPy,
    [curriculum_1.SuperBlocks.DataAnalysisPy]: Certification.DataAnalysisPy,
    [curriculum_1.SuperBlocks.InfoSec]: Certification.InfoSec,
    [curriculum_1.SuperBlocks.MachineLearningPy]: Certification.MachineLearningPy,
    [curriculum_1.SuperBlocks.CollegeAlgebraPy]: Certification.CollegeAlgebraPy,
    [curriculum_1.SuperBlocks.FoundationalCSharp]: Certification.FoundationalCSharp,
    [curriculum_1.SuperBlocks.RespWebDesignNew]: Certification.RespWebDesign,
    [curriculum_1.SuperBlocks.JsAlgoDataStruct]: Certification.JsAlgoDataStruct,
    [curriculum_1.SuperBlocks.FullStackDeveloper]: Certification.FullStackDeveloper,
    [curriculum_1.SuperBlocks.A2English]: Certification.A2English,
    [curriculum_1.SuperBlocks.B1English]: Certification.B1English,
    [curriculum_1.SuperBlocks.A1Spanish]: null,
    [curriculum_1.SuperBlocks.A2Spanish]: Certification.A2Spanish,
    [curriculum_1.SuperBlocks.A2Chinese]: Certification.A2Chinese,
    [curriculum_1.SuperBlocks.A1Chinese]: Certification.A1Chinese,
    [curriculum_1.SuperBlocks.PythonForEverybody]: null,
    [curriculum_1.SuperBlocks.CodingInterviewPrep]: null,
    [curriculum_1.SuperBlocks.ProjectEuler]: null,
    [curriculum_1.SuperBlocks.TheOdinProject]: null,
    [curriculum_1.SuperBlocks.RosettaCode]: null,
    [curriculum_1.SuperBlocks.BasicHtml]: null,
    [curriculum_1.SuperBlocks.SemanticHtml]: null,
    [curriculum_1.SuperBlocks.DevPlayground]: null,
    [curriculum_1.SuperBlocks.FullStackOpen]: null
};
